...
<body>
	<div>
		<table class="easyui-datagrid" id="userList" title="会员列表"
			data-options="singleSelect:false,collapsible:true,pagination:true,url:'/rest/club/',method:'get',pageSize:5,toolbar:toolbar,pageList:[5,10,20]">
			<thead>
				<tr>
					<th data-options="field:'ck',checkbox:true"></th>
					<th data-options="field:'id',width:60">ID</th>
					<th data-options="field:'fullName',width:100">队名</th>
					<th data-options="field:'cnName',width:200">队名(中)</th>
					<th data-options="field:'photo',width:100">队标</th>
					<th data-options="field:'clubStatsUrl',width:60">数据中心</th>
				</tr>
			</thead>
		</table>
	</div>
