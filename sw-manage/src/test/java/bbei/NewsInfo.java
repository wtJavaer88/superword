...
public class NewsInfo {
	...
	public String toString() {
		return "NewsInfo [website=" + website + ", title=" + title + ", url=" + url + ", sub_text=" + sub_text
				+ ", date=" + date + ", head_pic=" + head_pic + ", html_content=" + html_content + ", db_id=" + db_id
				+ ", cet_topics=" + cet_topics + ", keywords=" + keywords + ", topic_counts=" + topic_counts
				+ ", comment_counts=" + comment_counts + ", create_time=" + create_time + "]";
	}
