...
public class NewsExtract
{
    ...
    public List<Zb8News> getNewsAfterDay(String someday, int count,
            SportType type) throws Exception
    {
        String day2 = formatDay(BasicDateUtil.getDateAfterDayDateString(
                someday.replace("-", ""), count));
        return getNewsBetweenTwoDays(someday, day2, type);
    }

    public List<Zb8News> getNewsAfterDay(String someday, SportType type)
            throws Exception
    {
    ...
    public List<Zb8News> getNewsBetweenTwoDays(String day1, String day2,
            SportType type) throws Exception
    {
    ...
    public List<Zb8News> getNewsByYearMonth(int year, int month, SportType type)
            throws Exception
    {
        int days = 31;
    ...
    {
        someday = BasicDateUtil.getDateAfterDayDateString(
                someday.replace("-", ""), 1);
    ...
    {
        someday = someday.substring(0, 4) + "-" + someday.substring(4, 6) + "-"
                + someday.substring(6, 8);
        return someday;
    }
